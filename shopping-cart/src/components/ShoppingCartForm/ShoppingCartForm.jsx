   ...
   return (
        <form>
             <div className="shopping-cart__form-control">
               <input value={itemName} type="text" name="item-name" placeholder="Name" onChange={(e) => setItemName(e.target.value)}/>
            </div>
             <div className="shopping-cart__form-control">
               <input value={itemCost} type="number" name="item-cost" placeholder="Cost" onChange={(e) => setItemCost(e.target.value)}/>
            </div>
             <div className="shopping-cart__form-control">
               <input value={itemImgUrl} type="text" name="item-image" placeholder="Place image url here" onChange={(e) => setItemImgUrl(e.target.value)}/>
            </div>
             <div className="shopping-cart__form-control">
